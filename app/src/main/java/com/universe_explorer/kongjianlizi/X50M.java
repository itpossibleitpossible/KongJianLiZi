...
public class X50M extends Activity {
    ...
    int[] score= {252, 144, 140, 138, 132, 147, 186, 300, 350, 498, 627,
            655, 596, 431, 312, 254, 190, 266, 378, 743, 1531, 3324, 6554, 11393, 16186, 17636, 15461, 11456, 8762, 7537, 6731, 5636, 3950, 2918, 2220, 1681, 1342, 1048, 918, 774, 765, 577, 462, 354, 214, 162,
            93, 47, 44, 19, 16, 25, 18, 14, 14, 16, 18, 9, 14, 14,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1 = getIntent.getStringExtra("Intercept");
        s2 = getIntent.getStringExtra("B1");
        s3 = getIntent.getStringExtra("B2");
        ...
        for(int i=0; i<60; i++)
        {
           //a[i] = 5.0314+0.1168*(i+1)-4.84864*0.0000001*(i+1)*(i+1);
            a[i] = d1+d2*(i+1)+d3*0.0000001*(i+1)*(i+1);
            a[i] = Double.parseDouble(df1.format(a[i]));
        }


        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_x50_m);
