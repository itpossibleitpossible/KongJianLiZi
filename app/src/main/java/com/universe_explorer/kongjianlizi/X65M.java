...
public class X65M extends Activity {
    ...
    int[] score= {660, 510, 441, 446, 366, 417, 458, 503, 656, 931,
            1128, 1237, 1099, 839, 745, 648, 745, 1049, 1750, 3315,
            6197, 11998, 26011, 53959, 92039, 118043, 108142, 76687, 55958, 56824,
            63042, 56809, 38988, 22861, 14739, 11015, 8701, 6895, 6150, 6264,
            6435, 5977, 4847, 3671, 2440, 1590, 922, 540, 287, 219,
            153, 136, 126, 110, 99, 82, 94, 65, 84, 74,
    };//图表的数据
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_x65_m);
